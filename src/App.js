...
const FRAMEWORK_REFERENCES = {
  "SOC 2 Type II": "Reference for SOC 2 Trust Services Criteria — use ONLY these real control numbers and topics, and do not substitute another framework's domain names: CC1.x = Control Environment, CC2.x = Communication & Information, CC3.x = Risk Assessment, CC4.x = Monitoring Activities, CC5.x = Control Activities, CC6.x = Logical & Physical Access Controls, CC7.x = System Operations (7.1 Detection, 7.2 Monitoring, 7.3 Evaluation of Security Events, 7.4 Response & Remediation, 7.5 Recovery), CC8.x = Change Management, CC9.x = Risk Mitigation, A1.x = Availability (A1.1 Capacity Planning & Forecasting, A1.2 Environmental Protections/Backup/Recovery Infrastructure, A1.3 Recovery Plan Testing), C1.x = Confidentiality, PI1.x = Processing Integrity, P1.x-P8.x = Privacy. Do NOT use ISO 27001 Annex A domain names (e.g., 'Organization of Information Security', 'Information Security Policies and Procedures') to describe SOC 2 controls — these are a different framework."
};
